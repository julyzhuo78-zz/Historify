...
# r = requests.post(url, data = {'text': 'blah'})

# r = requests.post(url, data = {'ptName': '',
#         'cheifComplaint': '',
#         'onset': '',
#         'quality': '',
#         'radiate': '',
...
# r = requests.post(url, data = {'ptName': 'pascale',
#         'cheifComplaint': 'heart pain'})

r = requests.post(url, data = {'quality': 'shit'})
